...
static const char auth_key_test[] = "uJedoFrt3eta8z6yX98AA0lcZcFjWpKq";
static const char device_id_test[] = "tuyad9e5bc6d2acb";
static const uint8_t mac_test[6] = {0x26,0x49,0x75,0x4D,0x23,0xDC}; //The actual MAC address is : DC:23:4D:68:3A:91
...
void tuya_ble_app_init(void)
{
   ...
   if (!opt3004_init()) {
	   TUYA_APP_LOG_INFO("opt3004 init error");
   }
